...
|| <?php echo $row['created_at'];?>
			          				...
			          				<div class="form-group">
										...
										while($row22=mysqli_fetch_array($res22))
										{
											...
											<tr>
            			          			...
            			          			{
            			          			?>
												    <a href="designer/download_stl.php?id=<?php echo urlencode($row22['filename']) ?>"><?php echo $row22['filename'] ?></a>
												    <?php }else{ ?>
					...
					<a href="api/stl_files/<?php echo $row22['filename'] ?>"><?php echo $row22['filename'] ?></a>
							...
							if(strpos($row23['finished_file'],"#")>0)
										...
										<a href="designer/download_finished.php?id=<?php echo urlencode($row23['finished_file']) ?>"> <?php echo $row23['finished_file'] ?> || <?php echo $row23['created_at'] ?></a>
										<?php }else{?>
