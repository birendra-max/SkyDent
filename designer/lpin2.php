			             	...
			             	$amount=$row['package'];
			             		...
			             		?>
			                  		...
			                  		<td>
			                  			...
			                  			if ($row1['status']=='N' and is_numeric($nopin[$j])) {
			                  			?>
			                  		<a href="transfer.php?tpin=<?php echo $nopin[$j] ?>&amount=<?php echo $amount ?>&mainid=<?php echo $id ?>" class="btn btn-warning">Transfer Pin/Transfer</a> 
			                  			<?php		
			                  			}else
			                  			{
			                  			echo "<p class='btn btn-danger'>Not Avaible</p> ";
			                  			}
			                  			?>
