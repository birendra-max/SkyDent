                    ...
                    <div class="card-body">
                      ...
                      <hr>
                            ...
                            <div class="col-sm-3 sty">
                              <center>
                              <img src="admin/<?php echo $row['image'] ?>" style="width:100%" height="220"><br>
                              <h4 style="color:#000;font-size: 22px;font-weight: bold;"><?php echo $row['name'] ?></h4><br>   
                              <h5 style="color:green;font-size: 22px;"> <span class="fa fa-inr"></span> <?php echo $row['todaydate'] ?></h5><br>
                              <div class="row">
                                  
                                <div class="col-sm-6">
                                  <a href="viewpro.php?idd=<?php echo $row['id'] ?>" class="btn btn-info">View</a>
