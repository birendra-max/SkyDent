...
<nav class="main-header navbar navbar-expand-md navbar-light navbar-primary" style="display: none;">
    <div class="container">
      <a href="index.php" class="navbar-brand">
        
        <span class="brand-text font-weight-light"><?php echo substr($rowcp['cname'],0,9) ?></span>
      </a>
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
              ...
              <a href="index.php" class="nav-link" style="color: #FFF !important" >Dashboard</a>
            </li>   
           
            <li class="nav-item d-none d-sm-inline-block">
              <a href="donwline.php" class="nav-link" style="color: #FFF !important" >Orders</a>
            </li>  
            <li class="nav-item d-none d-sm-inline-block">
              <a href="new_request.php" class="nav-link" style="color: #FFF !important" >File Upload Center</a>
            </li>  
            <li class="nav-item d-none d-sm-inline-block">
              <a href="report.php" class="nav-link" style="color: #FFF !important" >Reports</a>
            </li>  
            <li class="nav-item d-none d-sm-inline-block">
              <a href="msearch.php" class="nav-link" style="color: #FFF !important" >Multiple Search</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
           ...
           <!-- SEARCH FORM -->
        <form class="form-inline ml-0 ml-md-3" method="post" action="upload2.php">
