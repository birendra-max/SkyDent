...
// CHECK HERE TO SELECT UPLINER IS ALREADY FILL OR NOT
	...
	if ($side=='left') {
		...
		$rr=mysqli_query($bd,"SELECT * FROM user WHERE sponserid='$dirref' AND side='left'");
		...
		$rr=mysqli_query($bd,"SELECT * FROM user WHERE sponserid='$dirref' AND side='right'");
		if (mysqli_num_rows($rr)>0) {
			$flagr=1;
			$allflag=1;
		}
...
//UPDATING THE MEMBER INFORMATION	
	...
	mysqli_query($bd,"INSERT INTO bank(id,account,bank,branch,ifsc)VALUES('$savepin2','0','0','0','0')");
		$kk=10;
		   ...
		   $to =$email;
         $subject = "Congratulation, Registration Success From Mridu Production";
         
         $message = "<h3><b>Congratulation, You have successfully registetred with SelfLife.Now Earn More For activate self ID and add more members at bottom your.Your Login Credentials is <br> ID :$savepin2 and default Password is : 12345. <br><br> Thanks Regard <br> SelfLife </b></h3>";
         
         $header = "From:selflife2021@gmail.com \r\n";
         $header .= "Reply-To: selflife2021@gmail.com\r\n";
         $header .= "Return-Path: selflife2021@gmail.com\r\n";
         $header .= "Cc:selflife2021@gmail.com \r\n";
	...
	?>
	 <script>  
	    alert('You are successfully registered.Your Login ID is <?php echo $savecid ?>and Default Password is 12345 . You can change your password after the login ');
	...
	<?php
		...
		if ($flagl==1) {
			$kk=1;
			echo "<script>alert('This $dirref id of left is already completed.')</script>";
		}else{
			if ($flagr==1) {
				$kk=1;
			echo "<script>alert('This $dirref id of right is already completed.')</script>";
		}
		}		
		}
	}else{
...
<div class="register-box">
  ...
  <div class="card">
    <div class="card-body register-card-body"  style="background-color: rgba(0,0,0,0.1);">
      ...
      <form action="" method="post">
        ...
        <div class="input-group mb-3">
			...
			{?>
				...
				<input type="hidden" class="form-control"  name="ref" value="<?php echo $_REQUEST['x'] ?>" style="color: #000;font-weight: bold;font-size:16px;" placeholder="Sponsor ID" >
			
			<input type="text" class="form-control" value="<?php echo $_REQUEST['x'] ?>" style="color: #000;font-weight: bold;font-size:16px;" placeholder="Sponsor ID" readonly>	<br>				
        ...
        <label class="form-control">If you do not have sponsor id use 8899</label>       

        <div class="input-group mb-3" style="display:none;">
        	<?php
			if (isset($_REQUEST['x'])) {?>
        <input type="hidden"  name="upliner">  
          	...
          	if (isset($_REQUEST['di'])) {
          	 ...
          	 Left
	            <div class="icheck-success d-inline">
                    <input type="radio" name="side" checked id="radioSuccess1" value="left" checked>
                  ...
                  Right
                  <div class="icheck-success d-inline">
                    <input type="radio" name="side" id="radioSuccess2" value="right" checked>
                   ...
                   <input type="radio" name="side" value="left" style="height:16px;width:16px;margin-top: -15px;color: green;">Left
                   <br>

                   <input type="radio" name="side" value="right"  style="height:16px;width: 16px;margin-top: -15px">Right
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Registration Terms & Condition</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <p>Your registration will remain valid for 30 days, between this 30 days you can take any product and activate your Id and speed up your income.&hellip;</p>
            </div>
