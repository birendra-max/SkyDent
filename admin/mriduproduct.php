...
if (move_uploaded_file($tmp_name, $new_name)){
  ...
  if (mysqli_query($bd,"INSERT INTO product_item1(name,feature,image,amount,discount,p_type,todaydate) VALUES('$proname','$des','$new_name','$price','$discount','$pname','$tdate')")) {
