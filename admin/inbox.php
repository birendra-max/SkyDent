			        ...
			        <div class="row">
			          <div class="col-12">
			            <div class="card">
			              ...
			              <!-- /.card-header -->
			              <div class="card-body">
			              	<h2 class="text-center"><b>List Of E-Mail</b></h2>
			              <table  id="example1" class="table table-bordered table-striped">
			                  ...
			                  <tbody>
			                  	<?php
			                  	$i=1;			                  	
			                  	$rr=mysqli_query($bd,"SELECT * FROM maillist WHERE direct='Admin' ORDER BY id DESC");
			                  	while ($row=mysqli_fetch_assoc($rr)) {
			                  		...
			                  		<td> <a href="reply.php?idd=<?php echo $row['id'] ?>&reg=<?php echo $row['subject'] ?>" class="btn btn-info"> <span class="fas fa-reply"></span> Reply</a></td>
			                  		</tr>
			                  		<?php
			                  	}
			                  	?>
