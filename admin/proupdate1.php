...
if (move_uploaded_file($tmp_name, $new_name)){
  mysqli_query($bd,"UPDATE product_item1 SET image='$new_name' WHERE id=$iddd");
}
   }

  if (mysqli_query($bd,"UPDATE product_item1 SET p_type='$pname',name='$proname',feature='$des',amount='$price',discount='$discount' WHERE id=$iddd")) {
  ...
  echo "<script>window.location='mriduproduct1.php'</script>";
			    ...
			    <section class="content">
			      <div class="container-fluid">
			        <div class="row">
                      ...
                      <?php 
                      $idd=$_GET['idd'];
                      $rr1=mysqli_query($bd,"SELECT * FROM product_item1 WHERE id=$idd");
